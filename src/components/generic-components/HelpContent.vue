    ...
    <el-collapse v-model="openSections" class="help-collapse">
      <el-collapse-item name="start">
        ...
        <ul class="help-list">
          ...
          <li>
            <strong>Verify Email</strong> — Check your inbox for a verification
            link. You must verify before logging in.
          </li>
          <li>
      ...
      <el-collapse-item name="groups">
        ...
        <ul class="help-list">
          ...
          <li>
            <strong>Remove Members</strong> — Any member can request a removal;
            all remaining members must approve.
          </li>
          <li>
          ...
          <li>
            ...
            rename or delete a group. Deletion requires all members to approve.
          </li>
          <li>
            <strong>Filter &amp; Sort</strong> — Sort groups A–Z or Z–A. Filter
            groups by a specific member.
          </li>
        </ul>
      </el-collapse-item>
      ...
      <el-collapse-item name="expenses">
        ...
        <ul class="help-list">
          ...
          <li>
            <strong>Edit / Delete</strong> — Requests an edit or delete that all
            group members must approve before it takes effect.
          </li>
          <li>
          ...
          <li>
            <strong>Settlement</strong> — Shows who needs to pay whom to settle
            the current expenses. See the Settlement section below.
          </li>
          <li>
            <strong>Download</strong> — Export to PDF or Excel from any expense
            list.
          </li>
        </ul>
      </el-collapse-item>
      ...
      <el-collapse-item name="shared-loans">
        ...
        <ul class="help-list">
          <li>
            <strong>Add Loan</strong> — Record a loan between group members: who
            gave, who received, amount, and date.
          </li>
          <li>
            <strong>ME? Checkbox</strong> — Quickly select yourself as the giver
            or receiver without typing your details.
          </li>
          <li>
          ...
          <li>
            <strong>Loan Summary</strong> — See total lent, total borrowed, and
            your net balance with charts.
          </li>
          <li>
      ...
      <el-collapse-item name="personal-loans">
        ...
        <ul class="help-list">
          ...
          <li>
            ...
            registered user; their name and masked mobile fill in automatically.
          </li>
          <li>
            <strong>ME? Checkbox</strong> — Quickly fill in your own details as
            giver or receiver.
          </li>
          <li>
          ...
          <li>
            <strong>Loan Summary</strong> — Total you lent, total you borrowed,
            overall balance, with donut and bar charts.
          </li>
          <li>
            <strong>Who Pays Whom</strong> — Simplified settlement table for all
            personal loans.
          </li>
      ...
      <el-collapse-item name="settlement">
        ...
        <ul class="help-list">
          <li>
            <strong>What it is</strong> — After expenses are recorded, Kharchafy
            calculates the minimum set of payments to settle all balances.
          </li>
          <li>
            <strong>Request Settlement</strong> — Any member can request a
            settlement for a selected month. All members receive a notification
            to approve.
          </li>
          <li>
            <strong>Approve / Reject</strong> — Each member reviews and approves
            or rejects the settlement request.
          </li>
          <li>
      ...
      <el-collapse-item name="net-position">
        ...
        <ul class="help-list">
          ...
          <li>
            <strong>Net Position</strong> — A single number showing your overall
            balance. Positive means others pay you; negative means you pay
            others.
          </li>
          <li>
            <strong>Charts</strong> — A donut chart for the overall split and a
            bar chart for per-category breakdown.
          </li>
          <li>
      ...
      <el-collapse-item name="salary">
        ...
        <ul class="help-list">
          ...
          <li>
            <strong>Download</strong> — Export your salary and expense records.
          </li>
        </ul>
      </el-collapse-item>
      ...
      <el-collapse-item name="charts">
        ...
        <ul class="help-list">
          <li>
            <strong>Donut Charts</strong> — Show proportions, e.g. who paid what
            share, or lent vs. borrowed.
          </li>
          <li>
            <strong>Bar Charts</strong> — Compare amounts side by side, e.g. how
            much each person paid or owes.
          </li>
          <li>
            <strong>Where to find them</strong> — Inside the Expense Summary
            accordion on Shared Expenses, the Loan Summary accordion on Personal
            Loans and Shared Loans, and in the Expenses Summary dialog.
          </li>
          <li>
