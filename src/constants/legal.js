  ...
  ur: [
    {
      ...
      paragraphs: [
        ...
        'خرچے فائی کے مالک اور آپریٹر مجید علی ہیں، برانڈ نیم LocalhostOnly.tech کے تحت (majidev.netlify.app)۔ اس پالیسی یا اپنے ڈیٹا سے متعلق کسی بھی سوال کے لیے kharchafykhataapplication@gmail.com پر رابطہ کریں۔'
      ]
    },
    {
  ...
  ur: [
    {
      ...
      paragraphs: [
        'یہ شرائط و ضوابط ("شرائط") خرچے فائی کے استعمال کو کنٹرول کرتی ہیں، جو مجید علی / LocalhostOnly.tech چلاتے ہیں۔ اکاؤنٹ بنا کر یا خرچے فائی استعمال کر کے آپ ان شرائط اور ہماری پرائیویسی پالیسی سے متفق ہوتے ہیں۔ اگر آپ متفق نہیں تو براہ کرم ایپ استعمال نہ کریں۔'
      ]
    },
    {
      title: 'سروس کی تفصیل',
    ...
    },
    {
      ...
      paragraphs: [
        'قانون کی اجازت کی حد تک، خرچے فائی، مجید علی، اور LocalhostOnly.tech آپ کے ایپ استعمال سے پیدا ہونے والے بالواسطہ، اتفاقی، یا نتیجاتی نقصانات، ڈیٹا کے ضیاع، یا صارفین کے درمیان تنازعات کے ذمہ دار نہیں۔'
      ]
    },
    {
